            ...
            <div className={styles.base}>
                ...
                <section id="version">
                    ...
                    <p>
                        ...
                        <a
                            ...
                            href={`https://github.com/jannkasper/web-chat/commit/${process.env.REACT_APP_COMMIT_SHA}`}
                        >
                ...
                <section id="software">
                    ...
                    <p>
                        ...
                        <a href="https://github.com/jannkasper/web-chat" target="_blank" rel="noopener noreferrer">
                ...
                <section id="report-abuse">
                    ...
                    <p>
                        To report any content, email us at abuse[at]darkweb.io or submit the room ID below to report anonymously.
                    </p>
                ...
                <section id="acceptable-use">
                    ...
                    <p>
                        This Acceptable Use Policy (this “Policy”) describes prohibited uses of the web services offered by Darkweb
                        and its affiliates (the “Services”) and the website located at https://darkweb.io (the “Darkweb Site”).
                        The examples described in this Policy are not exhaustive. We may modify this Policy at any time by posting a
                        revised version on the Darkweb Site. By using the Services or accessing the Darkweb Site, you agree to the
                    ...
                    <p>
                        You may not use, or encourage, promote, facilitate or instruct others to use, the Services or Darkweb Site
                    ...
                    of the Services or Darkweb Site. We may:
                    <ul>
                        <li>investigate violations of this Policy or misuse of the Services or Darkweb Site; or</li>
                        <li>
                            remove, disable access to, or modify any content or resource that violates this Policy or any other
                            agreement we have with you for use of the Services or the Darkweb Site.
                        </li>
                        <li>
                ...
                <section id="terms">
                    ...
                    <p>
                        ...
                        https://darkweb.io website (the "Service") operated by Darkweb ("us", "we", or "our").
                    </p>
                    <p>
                    ...
                    <p>
                        Darkweb has no control over, and assumes no responsibility for, the content, privacy policies, or practices
                        of any third party web sites or services. You further acknowledge and agree that Darkweb shall not be
                ...
                <section id="disclaimer">
                    <h4>Disclaimer</h4>
                    <p className="bold">
                        WARNING: Darkweb does not mask IP addresses nor can verify the integrity of parties recieving messages.
                    ...
                    <p>
                        <strong>
                            OUR WEBSITE IS OPERATED BY Darkweb ON AN "AS IS," "AS AVAILABLE" BASIS, WITHOUT REPRESENTATIONS OR
                            WARRANTIES OF ANY KIND. TO THE FULLEST EXTENT PERMITTED BY LAW, Darkweb SPECIFICALLY DISCLAIMS ALL
                            ...
                            YOU PURCHASE THROUGH IT. Darkweb SHALL NOT HAVE ANY LIABILITY OR RESPONSIBILITY FOR ANY ERRORS OR
                            ...
                            ARE AT YOUR OWN RISK. IN NO EVENT SHALL EITHER Darkweb OR THEIR AGENTS BE LIABLE FOR ANY DIRECT,
                            ...
                            SUCH DAMAGES. IN NO EVENT SHALL Darkweb’s LIABILITY FOR ANY DAMAGE CLAIM EXCEED THE AMOUNT PAID BY YOU TO
                            Darkweb FOR THE TRANSACTION GIVING RISE TO SUCH DAMAGE CLAIM.
                        </strong>
                    </p>
                    <p>
                        <strong>
                    ...
                    <p>
                        <strong>
                            WITHOUT LIMITING THE FOREGOING, Darkweb DO NOT REPRESENT OR WARRANT THAT THE INFORMATION ON THE WEBITE IS
                    ...
                    <p>
                        <strong>
                            ...
                            NATURE, INCLUDING LOSS, DAMAGE, OR WARRANTY. Darkweb AND THEIR RESPECTIVE AFFILIATES MAKE NO
                            REPRESENTATION OR GUARANTEES ABOUT ANY CONTRACTS AND SERVICES OFFERED THROUGH OUR WEBSITE.
                        </strong>
                    </p>
                    <p>
                        <strong>
                            Darkweb MAKES NO REPRESENTATION THAT CONTENT PROVIDED ON OUR WEBSITE, CONTRACTS, OR RELATED SERVICES ARE
                            APPLICABLE OR APPROPRIATE FOR USE IN ALL JURISDICTIONS.
                        </strong>
                    </p>
                    <strong>Indemnification</strong>
                    <p>
                        You agree to defend, indemnify and hold Darkweb harmless from and against any and all claims, damages,
                    ...
                    <p>If you have any questions about these Terms, please contact us at hello[at]darkweb.io.</p>
                </section>

                <section id="contact">
                    <h4>Contact</h4>
                    <p>Questions/comments? Email us at hello[at]darkweb.io</p>
                    <p>
                        Found a bug or want a new feature?{" "}
                        <a href="https://github.com/jannkasper/web-chat/issues" target="_blank" rel="noopener noreferrer">
